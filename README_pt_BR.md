...
SRS/5.0(Bee) é um simples e altamente eficiente servidor de video em tempo real, ele possui suporte à RTMP/WebRTC/HLS/HTTP-FLV/SRT/GB28181.
...
> Nota:  A unica arquitetura de nodulo  unico para SRS, para maiss detalhes por favor acesse [aqui](https://www.figma.com/file/333POxVznQ8Wz1Rxlppn36/SRS-4.0-Server-Arch).

O SRS está licenciado sob [MIT](https://github.com/ossrs/srs/blob/develop/LICENSE) ou [MulanPSL-2.0](https://spdx.org/licenses/MulanPSL-2.0.html),
e note que [MulanPSL-2.0 é compativel com a Apache-2.0](https://www.apache.org/legal/resolved.html#category-a),
mas algumas bibliotecas de terceiros são distribuidas pelas suas [próprias licenças](https://ossrs.io/lts/en-us/license).

<a name="product"></a> <a name="usage-docker"></a>
## Uso

Por favor leia o guia [Primeiros passos (inglês)](https://ossrs.io/lts/en-us/docs/v4/doc/getting-started) ou [中文文档：起步 (mandarim)](https://ossrs.net/lts/zh-cn/docs/v4/doc/getting-started).

Para construir o SRS a partir da base:
...
Abra [http://localhost:8080/](http://localhost:8080/) to check it, then publish
